...
<table id="list">
            ...
            <c:forEach var="e" items="${list}" >
            	...
            	<tr class="data_row">
	            	...
	            	<td><input	 type="button" name="task_name" value="${e.task_name}" onclick="onNameClick()" id ="click-name">


					<div id="edit-popup-wrapper${e.task_name}">
					  <div id="edit-popup-inside">
					    <div id="edit-close">閉じる</div>
					      <div id="edit-message">
					     		<form method="POST" action="/Forza/TaskRegistServlet">
					            タスクの名前：<input type="text" name="task_name"><br>
					            <br>
